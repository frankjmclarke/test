...
const appleApiKey = 'appl_SyMijPRPZfLssEUHxybzWBDBUmr';

//TO DO: add the Google API key for your app from the RevenueCat dashboard: https://app.revenuecat.com

const googleApiKey = 'goog_lGvcOXCsXxsxGbVInWxMwFHCYXq';
const googleRcYearly = 'sl_3999_1y_1w0';
const googleRcMonthly = 'sl_499_1m_1d0';
